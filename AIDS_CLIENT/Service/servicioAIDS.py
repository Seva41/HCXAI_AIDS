...
logging.basicConfig(filename="C:\\Users\\mcabr\\Desktop\\log_service.log", level=logging.DEBUG)

class ServicioAIDS(win32serviceutil.ServiceFramework):
    _svc_name_ = "AIDS-service"
    _svc_display_name_ = "Servicio AIDS CLIENT"
    _svc_description_ = "Servicio para el funcionamiento del AIDS. Ejecuta el cliente según un tiempo determinado."
